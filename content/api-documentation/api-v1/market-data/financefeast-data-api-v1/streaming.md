...
please note the endpoint is `wss://data.financefeast.markets/stream` (papertrading API key works with this URL, too). At the
...
The stream names can optionally be prefixed by `financefeastdatav1/`
{{< snippet >}}
{
    "action": "listen",
    "data": {
        "streams": ["financefeastdatav1/T.SPY", "financefeastdatav1/Q.SPY", "financefeastdatav1/AM.SPY"]
    }
}
{{< /snippet >}}
...
{{< snippet >}}
$ wscat -c wss://data.financefeast.markets/stream
