import financefeast_trade_api as tradeapi
import time

if __name__ == '__main__':
    """
    With the financefeast API, you can open a short position by submitting a sell
    ...
    api = tradeapi.REST(
        ...
        'https://paper-api.financefeast.markets', api_version='v2'
    )
